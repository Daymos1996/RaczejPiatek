...
public class Profil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                mDialog = new ProgressDialog(profil.this);
                ...
                parameters.putString("fields","id,email,birthday,gender,friends");
    ...
    private void printKeyHash(){
        try{
            PackageInfo info = getPackageManager().getPackageInfo("com.example.kuba.raczejpiatek.user",PackageManager.GET_SIGNATURES);
